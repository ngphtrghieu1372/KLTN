  ...
  return (
    <div>
      ...
      <div className="search-cate">
        <div className="col-1 cate" style={{backgroundColor:'#fff'}}>
          <h3 style={{fontWeight:'bold'}}>NHÓM SẢN PHẨM</h3>
          <div>
            {loadingCategories ? (
              <LoadingBox></LoadingBox>
            ) : errorCategories ? (
          ...
          <div>
            <h3 style={{fontWeight:'bold'}}>GIÁ</h3>
            <ul>
              {prices.map((p) => (
                <li key={p.name}>
                  <Link
        ...
        <div className="col-3" style={{minWidth:'80%'}}>
          {loading ? (
            <LoadingBox></LoadingBox>
          ) : error ? (
            <MessageBox variant="danger">{error}</MessageBox>
